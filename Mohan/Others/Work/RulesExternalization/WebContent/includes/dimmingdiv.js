...
function buildDimmerDiv()
{
	...
	var sHeight = self.screen.availHeight;
	var nsHeight = (sHeight - 0);
	var sWidth = self.screen.availWidth;
	var nsWidth = (sWidth - 20);
	//alert(nsHeight);
	//getDim();
	document.write('<div id="dimmer" class="dimmer" style="width:'+ nsWidth + 'px; height:' + nsHeight +'px"></div>');
}
...
function displayFloatingDiv(divId, title, width, height, left, top) 
{
	...
	document.getElementById(divId).className = 'fd_Container';
