...
/*
 * +/- radioToggle the tree, where el is the <span class="b"> node
...
function treeToggle(el, force) {
	...
	//alert(el.childNodes[0].childNodes[0].childNodes[0].childNodes[0].childNodes[0].nodeValue);
	var linkText = el.childNodes[0].childNodes[0].childNodes[0].childNodes[0].childNodes[0].nodeValue
	...
	{ 
		...
		activeLink = el.childNodes[0].childNodes[0].childNodes[0].childNodes[0];
		showHereClass();
		//alert('activeLink: '+activeLink.className);
	}
}
...
function showHereClass(){
	activeLink.className = 'hereTree';
}
