...
public class PRV0552_0002_01 extends Rule {
	...
	public static RulesResult execute(RulesContext ctx, String ruleId)
		...
		Date mostRecentEventVoM580_M590_EventDate = null;
		...
		if (ctx != null) {
			...
			mostRecentEventVoM580_M590_EventDate = (Date) inputObjs.get(0);
			if (mostRecentEventVoM580_M590_EventDate == null) {
			...
			/*logger = (EnterpriseLogger) inputObjs.get(1);*/
		...
		if ((mostRecentEventVoM580_M590_EventDate
				.equals(mostRecentEventVoS509Date) || mostRecentEventVoM580_M590_EventDate
