...
/**
 * POJO for the rule "PRV0004.0001.01"
 * @author $authorName
 * @source $ruleDescriptor.getRuleExtractClassName()
 */
public class PRV0004_0001_01 extends Rule {
	
    /* Static logger to log a message */
    private static final Logger LOG = Logger.getLogger(PRV0004_0001_01.class);
    ...
    public static RulesResult execute(RulesContext ctx, String ruleId) throws RIFPOJORulesException {
        ...
        System.out.println("Rule PRV0004.0001.01 Flage==>"+ageFlag);
