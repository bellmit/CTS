...
/**
 * Ruleclass of the rule "PRV0174.0001.01"
 * 
 * @author POJO extracted from Class:ProviderAppMntHelper
 */
public class PRV0174_0001_01 extends Rule {

	/* Static logger to log a message */
	private static final Logger LOG = Logger.getLogger(PRV0174_0001_01.class);
	...
	public static RulesResult execute(RulesContext ctx, String ruleId)
		...
		if (affiliation.getMemberProviderSysId().equals(
				oldAffl.getMemberProviderSysId())
				&& affiliation.getGroupProviderSysId().equals(
						oldAffl.getGroupProviderSysId())
