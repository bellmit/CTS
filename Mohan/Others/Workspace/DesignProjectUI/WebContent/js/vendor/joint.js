...
joint.dia.Link = joint.dia.Cell.extend({
    ...
    markup: [
        '<path class="connection" fill="none" stroke="black"/>',
        '<path class="marker-source" fill="none" stroke="black" />',
        '<path class="marker-target" fill="none" stroke="black" />',
        '<path class="connection-wrap" fill="none" />',
        '<g class="labels"/>', 
        '<g class="link-tools"/>'
    ].join(''),
